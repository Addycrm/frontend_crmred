<template>
    <b-overlay :show="overlay">
        <form-wizard ref="wizardForm" color="#7367F0" :title="null" :subtitle="null"
            :layout="type != 'editar' ? 'vertical' : 'horizontal'" class="wizard-vertical">
            <tab-content title="Información básica" icon="feather icon-user"
                  ...
                  ></b-form-file> -->
                        ...
                        <b-col ms="12" md="6" ls="6" xl="6">
                            <b-form-group label="Nombre o Razón social" class="required">
                                <ValidationProvider v-slot="{ errors }" rules="required">
                                    <b-form-input :state="errors.length > 0 ? false : null" id="razon_social"
                                        name="razon_social" v-model="form.razon_social" @input="slug"
                        ...
                        <b-col>
                            <b-row>
                                <b-col ms="12" md="6" ls="8" xl="8">
                                    <b-form-group label="Doumento">
                                            <b-form-input  id="nit" name="nit"
                                                v-model="form.nit" />
                                    </b-form-group>
                                </b-col>
                                <b-col ms="12" md="6" ls="4" xl="4">
                                    <b-form-group label="DV">
                                            <b-form-input  id="dv" name="dv"
                                                v-model="form.dv" />
                                    </b-form-group>
                                </b-col>
                            </b-row>
                        ...
                        <b-col ms="12" md="6" ls="6" xl="4">
                            <b-form-group label="URL de la empresa" class="required">
                                <ValidationProvider v-slot="{ errors }" rules="required">
                                    <b-input-group append=".inmob.site" class="input-group-merge">
                                        <b-form-input :state="errors.length > 0 ? false : null" id="slug_empresa"
                                            name="slug_empresa" v-model="form.slug" @input="slug"
                                            placeholder="Nombre o Razon social" />
                                    </b-input-group>
                                </ValidationProvider>
                                <div>
                        ...
                        <b-col ms="12" md="6" ls="6" xl="4">
                            <b-form-group label="Correo electrónico" class="required">
                                <ValidationProvider v-slot="{ errors }" rules="required|email">
                                    <b-form-input :state="errors.length > 0 ? false : null" id="email" type="email"
                                        v-model="form.email" />
                                </ValidationProvider>
                            </b-form-group>
                        </b-col>
                        ...
                        <b-col ms="12" md="6" ls="4" xl="4">
                            <b-form-group label="Color Principal"
                                ...
                                <b-form-input id="color_primario" name="color_primario" type="color"
                        ...
                        <b-col ms="12" md="6" ls="4" xl="4">
                            <b-form-group label="Color de fuente"
                                description="Es el color principal del texto del sitio web.">
                                <b-form-input id="color_fuente" name="color_fuente" type="color"
            ...
            <tab-content title="Ubicación" icon="feather icon-map-pin"
                ...
                <ValidationObserver ref="wizardFormUbicacion">
                    <b-row>
                            ...
                            <b-row>
                                <b-col ms="12" md="6" ls="6" xl="6">
                                    <b-form-group label="País">
                                        <v-select v-model="ubicaciones['id_pais'].value" @input="resetUbicacion('id_pais')"
                                            label="name" :options="storeConfig.country" :reduce="(type) => type.id"
                                            :clearable="false" />
                                    </b-form-group>
                                </b-col>
                                <b-col ms="12" md="6" ls="6" xl="6">
                                    ...
                                    <b-form-group label="Dirección">
                                        <b-input-group>
                                            <GmapAutocomplete @place_changed="setPlace" class="form-control"
                                                @input="setAddress" :value="form.direccion" :options="{
                                                    fields: [
                                                        'geometry',
                                                        'formatted_address',
                                                        'address_components',
                        ...
                        <b-col>
                            <p class="mb-1">
                                <b-badge variant="light-warning" class="font-weight-bold">En caso de que tu dirección no
                                    este registrada,
            ...
            <tab-content title="Descripción" icon="feather icon-info"
                :before-change="() => wizardFormValidate('wizardFormBasica')">
                    ...
                    <b-row>
                        <b-col>
                            <b-form-group label="Descripción de la Empresa">
                                ...
                                <quill-editor v-model="form.descripcion" :options="descriptionOptions"
                    ...
                    <b-row>
                            ...
                            <b-form-group label="Facebook">
                                <b-input-group>
                                    <b-input-group-prepend>
                                        <i class="icon" style="color: #1b74e4"><svg xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 320 512">
                        ...
                        <b-col ms="12" md="6" ls="6" xl="6">
                            <b-form-group label="Instagram">
                                <b-input-group>
                                    <b-input-group-prepend>
                                        <i class="icon" style="color: #dd2a7b"><svg xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 448 512">
                                                <!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                                                <path
                        ...
                        <b-col ms="12" md="6" ls="6" xl="6">
                            <b-form-group label="LinkedIn">
                                <b-input-group>
                                    <b-input-group-prepend>
                                        <i class="icon" style="color: #0a66c2"><svg xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 448 512">
                                                <!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                                                <path
            ...
            <template v-if="type != 'registrar'" slot="footer" slot-scope="props">
                <b-button :variant="!props.isLastStep ? 'primary' : 'success'"
                    @click=" !props.isLastStep ? props.nextTab() : wizardFormValidate(props.activeTabIndex)"
                    :disabled="overlay">
