...
export default {
  ...
  methods: {
    ...
    getPortales() {
      this.$store
        ...
        .then((response) => {
          ...
          var data = this.infoModal.content.portales_inmuebles_estado_fisico;
    ...
    hideModal() {
      this.$refs["modal-estado-fisico"].hide();
    },
    ...
    handleSubmit() {
      this.$store
        .dispatch("appPortales/addEstadoFisicoPortales", {
          portales: this.portales,
          id: this.infoModal.content.id,
        })
        .then(() => {
          this.$store
            .dispatch("apiInmueblePrivate/getStateFisico", {})
            .then(() => {});
          this.hideModal();
        })
        .catch((error) => {
