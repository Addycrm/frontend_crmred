<template>
  <b-modal
    :id="infoModal.id"
    ref="modal-caraceristicas-externas"
    title=""
    ok-title="Registrar"
...
export default {
  ...
  data() {
    return {
      infoModal: {
        id: "modal-caraceristicas-externas",
        title: "",
        content: {},
        contentPreguntas: {},
      },
  ...
  methods: {
    ...
    getPortales() {
      this.$store
        ...
        .then((response) => {
          ...
          var data = this.infoModal.content.portales_caracteristicas_externas;
    ...
    hideModal() {
      this.$refs["modal-caraceristicas-externas"].hide();
    },
    ...
    handleSubmit() {
      this.$store
        .dispatch("appPortales/addCaracteristicasExternas", {
          portales: this.portales,
          id: this.infoModal.content.id,
        })
        .then(() => {
          this.$store
            .dispatch("apiInmueblePrivate/getCaracteristicasExternas", {})
            .then(() => {});
          this.hideModal();
        })
        .catch((error) => {
