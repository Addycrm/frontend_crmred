...
export default {
  ...
  methods: {
    ...
    getPortales() {
      this.$store
        ...
        .then((response) => {
          ...
          var data = this.infoModal.content.portales_tipo_inmueble;
    ...
    hideModal() {
      this.$refs["modal-tipo-inmueble"].hide();
    },
    ...
    handleSubmit() {
      this.$store
        .dispatch("appPortales/addTipoInmueblePortal", {
