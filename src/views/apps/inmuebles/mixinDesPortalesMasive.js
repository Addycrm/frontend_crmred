...
export default {
    ...
    methods: {
        ...
        selectPortales(portales, inmueble) {
            ...
            this.DepublicateValidatePortal(_portales, inmueble)
        },
        async DepublicateValidatePortal(portales, inmueble) {
            ...
            `
                try {
                    ...
                    if (res.state) {
                        ...
                        this.$refs[item.id][0].innerHTML = `<p style="margin:0; color:gray; font-weight:bold;">Despublicado</p>`
                        this.$refs[item.name][0].innerHTML = ""
                        this.$refs[item.name][0].innerHTML =
                            `
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="svg_icon"
                    style="width:40px; fill: gray;">
                    <path
