...
export default {
  ...
  computed: {
    ...
    roles() {
      return this.$store.state.appRole.role_users_all;
    },
  },
  ...
  methods: {
    ...
    hideModal() {
      this.$refs["modal-user-edict"].hide();
    },
        ...
        .then(() => {
          this.$toast({
            ...
            props: {
              ...
              text: 'Los datos del Agente se han actualizado exitosamente',
              variant: "success"
            }
          });
