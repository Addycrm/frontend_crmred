...
export default {
  ...
  methods: {
    ...
    getPortales() {
      this.$store
        ...
        .then((response) => {
          ...
          let count = 0;
          var data = this.infoModal.content.portales_countrie;
    ...
    hideModal() {
      this.$refs["modal-countrie-portales"].hide();
    },
    ...
    handleSubmit() {
      this.$store
        .dispatch("appPortales/addCountryPortal", {
