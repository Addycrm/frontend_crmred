...
export default {
  ...
  methods: {
    ...
    getPortales() {
      this.$store
        ...
        .then((response) => {
          ...
          var data = this.infoModal.content.portales_barrio;
    ...
    hideModal() {
      this.$refs["modal-barrio-portales"].hide();
    },
    ...
    handleSubmit() {
      this.$store
        .dispatch("appPortales/addBarrioPortales", {
          portales: this.portales,
          id: this.infoModal.content.id,
        })
        .then(() => {
          this.$store
            .dispatch("appLocalidades/getBarrio", {
