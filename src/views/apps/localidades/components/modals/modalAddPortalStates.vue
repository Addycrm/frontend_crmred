...
export default {
  ...
  methods: {
    ...
    getPortales() {
      this.$store
        ...
        .then((response) => {
          ...
          var data = this.infoModal.content.portales_states;
    ...
    hideModal() {
      this.$refs["modal-states-portales"].hide();
    },
    ...
    handleSubmit() {
      this.$store
        .dispatch("appPortales/addStatePortal", {
