        ...
        <div class="demo-vertical-spacing">
          <form ref="form" @submit.stop.prevent="handleSubmit">
            ...
            >
              <b-form-input
                id="actions"
                v-model="infoModal.content.action"
                :state="actionsState"
                required
              />
            </b-form-group>
    ...
    handleSubmit() {
      ...
      this.$store
        .dispatch("appRole/addActions", {
          ...
          action: this.infoModal.content.action,
      ...
      this.$nextTick(() => {
        this.$refs["modal-edict-action-module"].toggle("#toggle-btn");
      });
    },
  },
};
